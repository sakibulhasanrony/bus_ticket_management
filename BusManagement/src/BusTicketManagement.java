...
public class BusTicketManagement {
	...
	password = in.readLine();
    	...
    	if(user.equals("sakib") && password.equals("12345")){
	...
	//display the "Destination", every destination "Fare", and the "Seat" available//
    	...
    	System.out.println("************************************************");
	System.out.println("** 1.)DHAKA CITY            | Taka600 |   "+available[1]+"   **");
        System.out.println("** 2.)BARISAL CITY          | Taka170 |   "+available[2]+"   **");
    	System.out.println("** 3.)KHULNA                | Taka150 |   "+available[3]+"   **");
    	System.out.println("** 4.)SYLHET                | Taka200 |   "+available[4]+"   **");
    	System.out.println("** 5.)CHITTAGONG            | Taka250 |   "+available[5]+"   **");
    	System.out.println("*************************************************");
	System.out.println("******************************************\n");
	...
	//if Passenger's Name already used, display error and go back to Inputing//
 	...
 	if(available[to]==0){
  	System.out.println("Sorry, We don't have available seat!");
    	...
    	String dest[] = { " ", "DHAKA CITY", "BARISAL CITY", "KHULNA", "SYLHET", "CHITTAGONG"};
    	...
    	System.out.println("FARE PRICE: Taka " + ticketD[z][0]);
	...
	System.out.println("FARE PRICE: Taka" + ticketD[b][0]);
	...
	System.out.println("CHANGE: Taka "+change[b]);
	System.out.println("");
	x=0;
	    }
	   }
	...
	System.out.println("***************************************");
    	...
    	System.out.println("FARE PRICE: Taka" + ticketD[x][0]);
    	System.out.println("NO. OF PASSENGERS: " + ticketI[x][0]);
    	System.out.println("NO. OF PASSENGERS WITH DISCOUNT: " + ticketI[x][1]);
    	System.out.println("TOTAL FARE PRICE: Taka " + ticketD[x][2]);
   	if(ticketS[x][2].equals("x")){
    	System.out.println("PAY: Taka " +pay[x]);
    	System.out.println("CHANGE: Taka " +change[x]);
    	System.out.println("STATUS: Taka");
    	}
    	else{
